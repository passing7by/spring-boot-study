...
ALTER TABLE `ACCOUNT`
ADD CONSTRAINT `FK_ACCOUNT1` FOREIGN KEY (`USERNAME`) REFERENCES `MEMBERS` (`USERNAME`);
ALTER TABLE `ACCOUNT`
ADD CONSTRAINT `FK_ACCOUNT2` FOREIGN KEY (`PRODUCT_NUM`) REFERENCES `PRODUCTS` (`PRODUCT_NUM`);

ALTER TABLE `ACCOUNT` ADD UNIQUE (`USERNAME`, `PRODUCT_NUM`);
...
INSERT INTO ACCOUNT (ACCOUNT_NUM, USERNAME, PRODUCT_NUM, ACCOUNT_DATE, ACCOUNT_BALANCE)
VALUES ('1111', 'new', 3, NOW(), 0);
